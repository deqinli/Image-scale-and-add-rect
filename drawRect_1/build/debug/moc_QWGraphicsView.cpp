...
void QWGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QWGraphicsView::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWGraphicsView::mouseMovePoint)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QWGraphicsView::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWGraphicsView::mouseClicked)) {
                *result = 1;
                return;
            }
        }
